...
//the class GameInterface displays a different message either if the game is won or lost by the player
...
public class GameInterface {
	...
	// METHODS 
	/* Method displaying a message by taking into account the outcome of the game */
