...
public class Collision {
	 ...
	 * the Hero contain a solidArea shifted by solidAreax and solidAreay
	 * When the character encounters an object, it sets :
	 * - The boolean collisionOn to true
	 * - we add to the solidArea's x and y of the Hero and the solidArea's x and y of the object their respective positions
	 * - we check if the new value of solidArea's are superposed then there is collision with objects*/
